...
// Spork 15 min protocol enforcement
static const int MIN_PEER_PROTO_VERSION_BEFORE_ENFORCEMENT = 70208;
static const int MIN_PEER_PROTO_VERSION_AFTER_ENFORCEMENT = 70209;
