...
bool CSporkManager::IsSporkActive(int nSporkID)
{
    ...
    if(mapSporksActive.count(nSporkID)){
        ...
        switch (nSporkID) {
            ...
            case SPORK_15_NEW_COLLATERAL_ENFORCEMENT:       r = SPORK_15_NEW_COLLATERAL_ENFORCEMENT_DEFAULT; break;
            case SPORK_16_PROTOCOL_VER_ENFORCEMENT:         r = SPORK_16_PROTOCOL_VER_ENFORCEMENT_DEFAULT; break;
            default:
...
int64_t CSporkManager::GetSporkValue(int nSporkID)
{
    ...
    switch (nSporkID) {
        ...
        case SPORK_15_NEW_COLLATERAL_ENFORCEMENT:       return SPORK_15_NEW_COLLATERAL_ENFORCEMENT_DEFAULT;
        case SPORK_16_PROTOCOL_VER_ENFORCEMENT:         return SPORK_16_PROTOCOL_VER_ENFORCEMENT_DEFAULT;
        default:
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_15_NEW_COLLATERAL_ENFORCEMENT")       return SPORK_15_NEW_COLLATERAL_ENFORCEMENT;
    if (strName == "SPORK_16_PROTOCOL_VER_ENFORCEMENT")         return SPORK_16_PROTOCOL_VER_ENFORCEMENT;
...
std::string CSporkManager::GetSporkNameByID(int nSporkID)
{
    switch (nSporkID) {
        ...
        case SPORK_15_NEW_COLLATERAL_ENFORCEMENT:       return "SPORK_15_NEW_COLLATERAL_ENFORCEMENT";
        case SPORK_16_PROTOCOL_VER_ENFORCEMENT:         return "SPORK_16_PROTOCOL_VER_ENFORCEMENT";
        default:
